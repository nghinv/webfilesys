...
public class ResizeImageRequestHandler extends UserRequestHandler
{
    ...
    protected void process()
    {
        ...
        output.println("<script src=\"/custom/webfilesys/javascript/errorHandling.js\" type=\"text/javascript\"></script>");
        ...
        output.println("{");
        output
                .println("  parent.DirectoryPath.location.href='/custom/webfilesys/servlet?command=exp&expand="
                        + UTF8URLEncoder.encode(actPath.replace('/',
                                File.separatorChar)) + "';");
        output
                .println("  window.location.href='/custom/webfilesys/servlet?command=listFiles';");
        output.println("}");
        output.println("function gotoScaledPictures()");
        output.println("{");
        output
                .println("  parent.DirectoryPath.location.href='/custom/webfilesys/servlet?command=exp&expandPath="
