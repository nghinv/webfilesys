...
public class DiskQuotaRequestHandler extends UserRequestHandler
{
	...
	protected void process()
	{
		...
		if (fileSysStat.getTotalSizeSum() <= userDiskQuota)
		{
			...
			output.print("<img src=\"/custom/webfilesys/images/space.gif\" border=\"0\" height=\"10\" width=\"" + imgWidth + "\">");
			output.println("</td>");
			output.println("<td class=\"accountDiskUsage accountDiskFree\">");
			output.print("<img src=\"/custom/webfilesys/images/space.gif\" border=\"0\" height=\"10\" width=\"" + (300L - imgWidth) + "\">");
			output.println("</td>");
