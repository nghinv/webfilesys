...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css">
      <xsl:attribute name="href">/custom/webfilesys/styles/skins/<xsl:value-of select="/concatParams/css" />.css</xsl:attribute>
    </link>
    ...
    <script type="text/javascript">
      <xsl:attribute name="src">/custom/webfilesys/servlet?command=getResourceBundle&amp;lang=<xsl:value-of select="/concatParams/language" /></xsl:attribute>
    </script>
