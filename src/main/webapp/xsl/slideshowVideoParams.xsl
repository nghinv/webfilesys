...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css">
      <xsl:attribute name="href">/custom/webfilesys/styles/skins/<xsl:value-of select="/videoParams/css" />.css</xsl:attribute>
    </link>
    ...
    <script type="text/javascript">
      <xsl:attribute name="src">/custom/webfilesys/servlet?command=getResourceBundle&amp;lang=<xsl:value-of select="/videoParams/language" /></xsl:attribute>
    </script>
