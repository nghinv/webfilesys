...
<html>
  <head>
    ...
    <script language="JavaScript" src="/custom/webfilesys/javascript/ajaxUpload.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
      <xsl:attribute name="src">/custom/webfilesys/servlet?command=getResourceBundle&amp;lang=<xsl:value-of select="language" /></xsl:attribute>
    </script>
    ...
    <script language="JavaScript" src="/custom/webfilesys/javascript/multiUpload.js" type="text/javascript"></script>
  </head>
      ...
      <tr>
        <td class="formButton">
          ...
          <input id="doneButton" type="button" style="visibility:hidden" resource="upload.button.done"
                 onclick="window.location.href='/custom/webfilesys/servlet?command=listFiles&amp;keepListStatus=true'" />
        </td>
        
        <td class="formButton" align="right">
          <input type="button" onclick="window.location.href='/custom/webfilesys/servlet?command=listFiles&amp;keepListStatus=true'" resource="button.cancel" />
        </td>
      </tr>
  ...
  <div id="uploadStatus" class="uploadStatus" style="visibility:hidden">
    ...
    <center>
      ...
      <div class="uploadStatusBar">
        ...
        <img id="todo" src="/custom/webfilesys/images/space.gif" width="299" height="20" border="0" />  
      </div>
      ...
      <div class="uploadStatusBar">
        <img id="totalDone" src="/custom/webfilesys/images/bluedot.gif" width="1" height="20" border="0">
          <xsl:attribute name="src">/custom/webfilesys/img-skin/<xsl:value-of select="css" />/progressbar.gif</xsl:attribute>
        </img>
        <img id="totalTodo" src="/custom/webfilesys/images/space.gif" width="299" height="20" border="0" />  
      </div>
